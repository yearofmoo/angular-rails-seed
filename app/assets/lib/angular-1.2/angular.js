 ...
 */
var version = {
  full: '1.1.6-2430347',    // all of these placeholder strings will be replaced by grunt's
...
var $AnimateProvider = ['$provide', function($provide) {
   ...
   *<pre>
   *   return {
     *     eventFn : function(element, done, index) {
     *       //code to run the animation
     *       //once complete, then run done()
  ...
  this.$get = ['$timeout', function($timeout) {
    ...
    return {
      ...
      move : function(element, parent, after, done, index) {
        ...
        this.enter(element, parent, after, done, index);
      },
        ...
        $scope.$watchCollection(rhs, function ngRepeatAction(collection){
          ...
          for (key in lastBlockMap) {
            if (lastBlockMap.hasOwnProperty(key)) {
              ...
              $animate.leave(block.elements, noop, removeIndex++);
          ...
          for (index = 0, length = collectionKeys.length; index < length; index++) {
            ...
            if (block.startNode) {
              ...
              if (block.startNode == nextNode) {
                ...
                $animate.move(block.elements, null, jqLite(previousNode), noop, index);
              }
            ...
            if (!block.startNode) {
              linker(childScope, function(clone) {
                $animate.enter(clone, null, jqLite(previousNode), noop, newIndex++);
                previousNode = clone;
